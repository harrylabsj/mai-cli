...
python3 scripts/mai.py --db ./mai-cli.sqlite audit events --merchant seller-a --event agent_token_rotated --limit 50 --offset 0
python3 scripts/mai.py --db ./mai-cli.sqlite audit events --merchant seller-a --event agent_token_rotated --limit 50 --offset 0 --format json
