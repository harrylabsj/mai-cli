...
Next:
  ...
  Smoke:    cd "$ROOT_DIR" && python3 scripts/mai.py --help && python3 scripts/mai.py api routes --format json
  Daemon:   python3 scripts/mai.py agent start --merchant MERCHANT --db ./mai-cli.sqlite --interval 3
EOF
